...
- `ai-music-order-desk.html` - AI music order desk that combines use case, package, reference sample, buyer contact, source-rights, publishing channel, CTA, creative notes, and an after-acceptance payment handoff into one buyer flow before payment
