...
- `assets/audio/*.wav` / `scripts/render-jingle-samples.mjs` - reproducible public sample audio for the AI jingle and product-video package cards, including a product demo hook sample that now has a copyable sample-to-order packet
