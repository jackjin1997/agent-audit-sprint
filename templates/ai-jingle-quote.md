# AI Jingle Package Quote

Use this only after the jingle brief/package is accepted in writing.
...
```text
Payment timing:
After written brief acceptance only.
...
Start rule:
The delivery target starts after both written brief acceptance and payment confirmation.

Usage guardrails:
No known-artist soundalikes, living voice clones, or third-party lyrics without rights. AI-generated music can have copyright-registration limits; this is not legal clearance.
```
