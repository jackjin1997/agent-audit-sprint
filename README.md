...
- `ai-music-samples.html` - public AI music sample-to-order page with five WAV references, a sample brief builder that generates copy/email/GitHub order packets, copyable and email-ready paid brief packets, SaaS launch order routing, product-video order routing, general AI music order routing, direct SaaS/product/podcast fast-lane desk links, and after-acceptance payment guardrails
