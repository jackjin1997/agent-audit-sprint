...
- `ai-music-samples.html` - public AI music sample-to-order page with four WAV references, copyable paid brief packets, product-video order routing, general AI music order routing, and after-acceptance payment guardrails
