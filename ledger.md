...
| Automated goal status monitor | `.github/workflows/goal-status-monitor.yml`, `scripts/check-goal-status.mjs`, `scripts/install-goal-monitor-launchd.mjs` | Added 4-hour GitHub check and local 15-minute macOS launchd loop for open intake issues and ETH/SOL stablecoin/native payment signals; failures are attention alerts, not revenue recognition |
