...
const aiMusicOrderLanes = {
  ...
  rush: {
    useCase: "Short-form ad or UGC hook",
    packageChoice: "USD $49 Same-Day Hook Sketch",
    sample: "Product Demo Hook",
    brand: "Same-Day Launch Clip",
    projectUrl: "https://example.com/urgent-clip",
    contact: "buyer@example.com",
    lengthSeconds: "12",
    variants: "1",
    cutPlan: "single",
    revisions: "0",
    timing: "24h rush requested, confirm availability first",
    channel: "Paid social ad or product launch",
    rights: "Buyer-owned tagline or voiceover",
    audience: "A launch, ad, podcast, product, or creator clip that needs one usable hook direction quickly.",
    cta: "CTA: publish the clip today. Required phrase: make the first five seconds count.",
    notes: "Rush path: one selected 8-15 second direction only. Confirm availability before acceptance and payment. Avoid known-artist soundalikes, celebrity voices, copyrighted songs, and third-party lyrics.",
  },
  listing: {
