...
| Automated goal status monitor | `.github/workflows/goal-status-monitor.yml`, `scripts/check-goal-status.mjs` | Added 4-hour scheduled check for open intake issues and ETH/SOL stablecoin/native payment signals; failures are attention alerts, not revenue recognition |
